 <?php
function validarFoto( $nombreservicios, $update = false ){
    
    /*ESTE IF SE AGREGO EN EL VIDEO 265 y 266*/
    if($update){
        
        borrarCarpetas("FotosServicios/$nombreservicios");
    ...
    $dirSubida = "FotosServicios/$nombreservicios/";
                             
     $foto = $_FILES['fotoservicio']; /*aca tiene que venir el name que tiene el type="file" cuando cargamos la foto*/
