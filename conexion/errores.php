        ...
        case E_USER_WARNING:
            echo "
                <div class='alerta alerta_warning'>
                    ...
                    <div class='alerta_wrapper'> Error: [$errno] $errstr, este problema se presento en la linea $errline, en el archivo $errfile 
                    </div><a href='#' class='close err'><i class='glyphicon glyphicon-remove'></i></a>
                </div>
                ";
            exit;
        ...
        case E_USER_NOTICE:
            echo "
                <div class='alerta alerta_info'>
                    ...
                    <div class='alerta_wrapper'> Informacion: $errstr 
                    </div><a href='#' class='close err'><i class='glyphicon glyphicon-remove'></i></a>
                </div>
                ";
            break;
