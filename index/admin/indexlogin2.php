...
<body>
   ...
   <div >
        ...
        <a class="btn btn-primary" href="../editar2.php" style="margin-top:10px; padding:0;margin-right:40px; ">Editar Servicios<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <div class="caja">
                           <div class="caja-cabecera">
                               <h1 style="font-size: 24px;">Sus Servicios Registrados</h1>
                           </div>
