<!--DE indexlogin.php ME LO ENVIA ACA, QUE VOY A TENER LA PARTE DE EDITAR LOS SERVICIOS-->
<?php 
    session_start(); 
...
<head>
    <meta charset="UTF-8">
    <title>ArServicios - Editar Servicios</title>
          ...
          <div class="row">
             <div class="col-sm-5 col-centrar">
                <div class="caja text-center">
                     ...
                     <a class='btn btn-danger' href='<?php echo "editarservicio.php?eliminar={$_GET['confireliminarservicio']}"; ?>'>Sí</a>
                     <a class='btn btn-info' href="editarservicio.php">No</a>
                 </div>
             </div>
                               ...
                               <table class="table table-cell">
                                   ...
                                   <tbody>
                                      ...
                                      <?php
                                       ...
                                       $db->preparar("SELECT COUNT(id_servicio) FROM servicio ");
                                       $db->ejecutar();
                                       ...
                                       $iniciar = ($pagina-1) * $porPagina;
                                        ...
                                        $db->preparar("SELECT servicio.id_servicio, servicio.nombre, servicio.id_categoria, servicio.direccion, servicio.maps, categoria.nombre as categoriaName FROM servicio  INNER JOIN categoria ON servicio.id_categoria=categoria.id_categoria LIMIT $iniciar, $porPagina");
                                        $db->ejecutar();
                                        $db->prep()->bind_result( $dbid, $dbnombre, $dbcategoria, $dbdireccion, $dbmaps, $dbcategorianame);
                                        /*$db->resultado();*/
